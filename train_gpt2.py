...
# DDP launch for e.g. 10 GPUs:
# torchrun --standalone --nproc_per_node=10 train_gpt2.py
...
ddp = torch.cuda.is_available() and int(os.environ.get('RANK', -1)) != -1# is this a ddp run?
if ddp:
